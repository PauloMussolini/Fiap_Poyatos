(function (jQuery) {
    ...
    $.fn.ripple = function () {
        ...
        $(this).click(function (e) {
			...
			if (this.getAttribute('data-menu') != null){
				
				 if (dataMenu != this.getAttribute('data-menu')){
					 $("#nomeTela").removeClass("animated fadeInRight"); 
					 $("#btnIncluir").removeClass("animated fadeInLeft"); 
					 $("#btnAlterar").removeClass("animated fadeInLeft"); 
					 $("#btnExcluir").removeClass("animated fadeInLeft"); 
					 $("#btnExportar").removeClass("animated fadeInLeft"); 
				 
					$("#principal").empty();
					$("#principal").load( this.getAttribute('data-menu') + ".html"); 
					dataMenu  = this.getAttribute('data-menu');
				 }
